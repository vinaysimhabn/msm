...
#define	SSBI_REG_ADDR_IRQ_BASE		0x100
...
static const struct of_device_id pm8821_id_table[] = {
	{ .compatible = "qcom,pm8018", },
	{ .compatible = "qcom,pm8058", },
	{ .compatible = "qcom,pm8821", },
	{ }
};
MODULE_DEVICE_TABLE(of, pm8821_id_table);
...
static int pm8821_remove_child(struct device *dev, void *unused)
{
...
static int pm8821_remove(struct platform_device *pdev)
{
	...
	device_for_each_child(&pdev->dev, NULL, pm8821_remove_child);
	irq_set_chained_handler_and_data(irq, NULL, NULL);
	irq_domain_remove(chip->irqdomain);
...
static struct platform_driver pm8821_driver = {
	...
	.driver		= {
		.name	= "pm8821-core",
		.of_match_table = pm8821_id_table,
	},
};
